...
export const metadata: Metadata = { title:"MaintainIQ — Maintenance predictive IA pour actifs industriels", description:"Analysez vibrations, temperature et courant de vos machines. Predisez les pannes 72h a l'avance. Reduisez vos couts de maintenance de 40%." };
